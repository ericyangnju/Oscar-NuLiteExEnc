...
//------------------------------------------------------------------------------------------------//
#define TRIGGER_KEY_COUNT	(3)

#define TG1_PIN_MASK		BIT5
#define TG2_PIN_MASK		BIT6
#define TG3_PIN_MASK		BIT7
...
{ \
	{Default_KeyHandler, TG1F, BIT5, KEYPAD_GPIOA, KEYPAD_FALLING}, \
	{Default_KeyHandler, TG1R, BIT5, KEYPAD_GPIOA, KEYPAD_RISING}, \
	{Default_KeyHandler, TG1P, BIT5, KEYPAD_GPIOA, KEYPAD_PRESSING}, \
	{Default_KeyHandler, TG2F, BIT6, KEYPAD_GPIOA, KEYPAD_FALLING}, \
	{Default_KeyHandler, TG2R, BIT6, KEYPAD_GPIOA, KEYPAD_RISING}, \
	{Default_KeyHandler, TG2P, BIT6, KEYPAD_GPIOA, KEYPAD_PRESSING}, \
	{Default_KeyHandler, TG3F, BIT7, KEYPAD_GPIOA, KEYPAD_FALLING}, \
	{Default_KeyHandler, TG3R, BIT7, KEYPAD_GPIOA, KEYPAD_RISING}, \
	{Default_KeyHandler, TG3P, BIT7, KEYPAD_GPIOA, KEYPAD_PRESSING}, \
	{0, 0, 0, 0, 0}  \
	}; \
